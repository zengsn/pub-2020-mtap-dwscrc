...
for iTran=1:numOfAllTrain
    ...
    if strcmp(dbName,'AR111')==1
        % Rotation
        %tempory2 = imrotate(tempory1,5);
        %tempory2 = imresize(tempory2,[row,col]);
        % Random Erasing
    else
